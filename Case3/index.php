...
$articles=[
    new Articles("Fennel: The Vegetable that Makes You Look Good and Smell Good", "Fennel is the ultimate multi-tasking vegetable. Not only does it taste great in salads, roasted, or sautéed, but it also has some unique properties that make it a true beauty booster.<br><br>
    ...
    And there you have it, folks, fennel: the vegetable that makes you look good and smell good. Don't forget to stock up on this versatile veggie, your taste buds and your body will thank you.","Article"),
    new Articles("The Ultimate Scam Artists", "Dogs, man's best friend, or so they say. But have you ever stopped to think about what these furry little freeloaders are really up to? Let's take a closer look.<br><br>
...
So there you have it, folks. Dogs may be cute and cuddly, but don't let their innocent faces fool you. They're just a bunch of scam artists looking for their next free meal.","Article")
];
...
$vacancy= new Vacancies("Fullstack Developer", "Looking for a fullstack developer who can do everything from coding to fixing the printer. Must have superhuman abilities.","Job");